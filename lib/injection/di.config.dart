...
import '../data/services/network_services/dio_helper.dart' as _i19;
...
import '../data/services/network_services/interceptors/token_refresh_interceptor.dart'
    as _i6;
import '../data/services/network_services/rest_client.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i6.TokenRefreshInterceptor>(
        () => _i6.TokenRefreshInterceptor());
    gh.factory<_i7.Dio>(() => dioHelper.configApiDio(
          authInterceptor: gh<_i3.AuthInterceptor>(),
          tokenRefreshInterceptor: gh<_i6.TokenRefreshInterceptor>(),
        ));
    gh.factoryParam<_i8.RestClient, String?, dynamic>((
      baseUrl,
      _,
    ) =>
        _i8.RestClient(
    ...
    gh.factory<_i15.PostLoginWithUsernameAndPasswordUseCase>(() =>
