...
import '../data/services/network_services/commons/dio_helper.dart' as _i20;
...
import '../data/services/network_services/interceptors/token_refresh_interceptor.dart'
    as _i8;
import '../data/services/preference_services/injection_module.dart' as _i21;
...
import '../domain/use_cases/authentication/post_login_with_username_and_password_use_case.dart'
    as _i17;
import '../domain/use_cases/use_cases.dart' as _i19;
import '../presentation/pages/sign_in/bloc/sign_in_bloc.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i13.PostCreateAccessTokenUseCase>(() =>
        _i13.PostCreateAccessTokenUseCase(
            authenticationRepositoryIml:
                gh<_i10.AuthenticationRepositoryIml>()));
    gh.factory<_i14.PostCreateRequestTokenUseCase>(() =>
        _i14.PostCreateRequestTokenUseCase(
            authenticationRepositoryIml:
                gh<_i10.AuthenticationRepositoryIml>()));
    gh.factory<_i15.PostCreateSessionUseCase>(() =>
        _i15.PostCreateSessionUseCase(
            authenticationRepositoryIml:
                gh<_i16.AuthenticationRepositoryIml>()));
    gh.lazySingleton<_i17.PostLoginWithUsernameAndPasswordUseCase>(() =>
        _i17.PostLoginWithUsernameAndPasswordUseCase(
            authenticationRepositoryIml:
                gh<_i16.AuthenticationRepositoryIml>()));
    gh.lazySingleton<_i18.SignInBloc>(() => _i18.SignInBloc(
          gh<_i19.PostLoginWithUsernameAndPasswordUseCase>(),
...
class _$DioHelper extends _i20.DioHelper {}
