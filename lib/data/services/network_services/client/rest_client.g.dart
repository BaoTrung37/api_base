...
class _RestClient implements RestClient {
  ...
  Future<GuestSessionResponse> getGuestSession() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GuestSessionResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GuestSessionResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<SessionResponse> postCreateSession(SessionRequest body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<RequestTokenResponse> postCreateSessionWithLogin(
      SessionWithLoginRequest body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
